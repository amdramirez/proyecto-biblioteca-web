...
<%
    ...
    if (reservaId != null) {
        ...
        try {
            conn = getConnection();
            String sql = "{CALL devolucion_prestamo(?)}";
            ...
            if ("bibliotecario".equals(tipoUsuario)) {
                response.sendRedirect("panel-bibliotecario.jsp?success=devolucion");
            } else {
                response.sendRedirect("panel-usuario.jsp?success=devolucion");
            }
